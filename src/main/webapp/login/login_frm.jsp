...
<html lang="en" data-bs-theme="auto">
  <head>
  <script src="http://192.168.10.223/jsp_prj/login/js/color-modes.js"></script>
...
<link href="http://192.168.10.223/jsp_prj/login/css/bootstrap.min.css" rel="stylesheet">

<meta name="theme-color" content="#712cf9">
<!-- jQuery CDN 시작 -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
    <!-- Custom styles for this template -->
    <link href="http://192.168.10.223/jsp_prj/login/css/sign-in.css" rel="stylesheet">
