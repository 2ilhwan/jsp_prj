...
try{
ld.selectLogin(wmVO);//method가 return을 하지 않더라도 인스턴스 주소는 하나이기 때문에 wmVO에서 조회 결과를 사용할 수 있다. 	
...
<link rel="shorcut icon" href="http://192.168.10.223/jsp_prj/common/images/paka.jpg">
